...
public class MessageConsumer {
    ...
    public void onMessage(Message message, Channel channel) throws Exception {
        ...
        try {
            ...
            io.bluemacaw.msgsvr.entity.Message mongodbMessage = messageService.saveMessage(mqMessage);
