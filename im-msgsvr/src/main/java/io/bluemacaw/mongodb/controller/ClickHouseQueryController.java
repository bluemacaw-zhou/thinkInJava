...
public class ClickHouseQueryController {
    ...
    public Map<String, Object> getTotalCount() {
        long count = clickHouseQueryService.getTotalCount();
    ...
    public Map<String, Object> getRecentMessages(
        ...
        List<MsgAnalysisData> messages = clickHouseQueryService.getRecentMessages(limit);
    ...
    public Map<String, Object> getMessagesByFromId(
        ...
        List<MsgAnalysisData> messages = clickHouseQueryService.getMessagesByFromId(fromId, limit);
    ...
    public Map<String, Object> getMessagesByContactId(
        ...
        List<MsgAnalysisData> messages = clickHouseQueryService.getMessagesByContactId(contactId, limit);
    ...
    public Map<String, Object> getMessagesByTimeRange(
        ...
        List<MsgAnalysisData> messages = clickHouseQueryService.getMessagesByTimeRange(startTime, endTime, limit);
    ...
    public Map<String, Object> getMessageCountByDate(
        ...
        List<Map<String, Object>> stats = clickHouseQueryService.getMessageCountByDate(days);
    ...
    public Map<String, Object> getTopSenders(
        ...
        List<Map<String, Object>> topSenders = clickHouseQueryService.getTopSenders(limit);
     ...
     * Body: { "sql": "SELECT * FROM message.msg_analysis_data LIMIT 5" }
     */
    ...
    public Map<String, Object> executeCustomQuery(@RequestBody Map<String, String> request) {
        ...
        try {
            List<Map<String, Object>> result = clickHouseQueryService.executeCustomQuery(sql);
